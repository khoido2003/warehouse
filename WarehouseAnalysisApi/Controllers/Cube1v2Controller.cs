...
public class Cube1v2Controller : ControllerBase
{
    ...
    /*-------------------------Requirement 7-----------------------------
     ---------http://localhost:5164/api/v2/cube1v2/requirement7-----------*/
    
    [HttpGet("requirement7")]
    public async Task<IActionResult> GetRequirement7(int pageNumber = 1, int pageSize = 20, string city = "",string state = "")
    {
        try
        {
